...
{
public:
	ProjectManager(GLFWwindow* window,I8080* processor,NotificationManager* notificationManager,LastPathManager* LastPathManager,EmulationThread* emulationThread,Compiler* сompiler, Caretaker_Momento* processor_CaretakerMomento);
