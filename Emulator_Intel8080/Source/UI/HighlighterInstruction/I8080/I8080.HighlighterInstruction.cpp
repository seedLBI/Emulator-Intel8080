...
std::vector<NamedColor> Singleton_I8080_HighlighterInstruction::GetDefaultLightColors() {
	return {
		{ u8"Перемещение, сохранение и загрузка",	ImColor(34,157,39,255)},
		{ u8"Операции со стеком",					ImColor(146,56,160,255)},
		{ u8"Прыжки",								ImColor(200,90,0,255)},
		{ u8"Вызовы",								ImColor(0,149,230,255)},
		{ u8"Возвраты",								ImColor(230,0,0,255)},
		{ u8"Перезагрузки",							ImColor(0,149,230,255)},
		{ u8"Ввод\\Вывод",							ImColor(94,61,18,255)},
		{ u8"Инкремент",							ImColor(81,184,84,255)},
		{ u8"Декремент",							ImColor(182,118,118,255)},
		{ u8"Сложение",								ImColor(0,185,6,255)},
		{ u8"Вычитание",							ImColor(182,74,74,255)},
		{ u8"Логические",							ImColor(107,168,169,255)},
		{ u8"Повороты",								ImColor(0,128,255,255)},
		{ u8"Специальные",							ImColor(0,128,255,255)},
		{ u8"Управление",							ImColor(197,143,195,255)},
		{ u8"Дерективы компилятора",				ImColor(116,97,70,255)}
	};
}
