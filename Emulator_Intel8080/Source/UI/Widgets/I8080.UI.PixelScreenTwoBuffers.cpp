#include "I8080.UI.PixelScreenTwoBuffers.h"


Widget_PixelScreenTwoBuffers::Widget_PixelScreenTwoBuffers(I8080* processor) :I8080_Widget(u8"Продвинутый пиксельный экран") {
...
void Widget_PixelScreenTwoBuffers::Load(const std::string& Data) {
