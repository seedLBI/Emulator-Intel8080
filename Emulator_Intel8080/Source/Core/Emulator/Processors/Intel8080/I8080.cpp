...
void I8080::Init_External_Peripherals() {
	...
	for (int i = 0x00; i < 0xff; i++)
		External_Peripherals[i] = new Port(i);

	External_Peripherals[ 0x02 ] = new Port_ConsoleOutput();
	External_Peripherals[ 0x05 ] = new Port_PixelScreen();
	External_Peripherals[ 0x06 ] = new Port_PixelScreenTwoBuffers();
	External_Peripherals[ 0x07 ] = new Port_SymbolScreen();
	External_Peripherals[ 0x08 ] = new Port(0x08);
	External_Peripherals[ 0x09 ] = new Port_GeneratorRandomValues();
	External_Peripherals[ 0x10 ] = new Port_AsyncKeyboard();
	External_Peripherals[ 0x16 ] = new Port_Timer();
...
std::vector<Port*> I8080::Get_External_Peripherals() {
