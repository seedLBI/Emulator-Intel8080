...
std::vector<NamedColor> Singletone_InfoInstruction::GetDefaultLightColors() {
	return {
	{u8"Фон",						ImColor(222,207,182,255)},
	{u8"Номер линии (Псевдокод)",	ImColor(118,104,84,255)},
	...
	{u8"Байт (первый)",				ImColor(156,229,223,255)},
	...
	{u8"Флаг (Устанавливается 0)",	ImColor(122,0,78,255)},
	{u8"Флаг (Устанавливается 1)",	ImColor(122,0,78,255)},
	{u8"Внимание",					ImColor(191,0,0,255)}
	};
}
