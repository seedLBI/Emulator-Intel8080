...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_NoLabel                = 1 << 9,       // Enable wrapping around from max to min and from min to max (only supported by DragXXX() functions for now.
