...
{
public:
	Widget_Keyboard(FPS_Timer* fps_timer, TextEditor* editor);
	~Widget_Keyboard();
	void Draw() override;
...
private:
	...
	const std::vector<std::vector<std::string>> layers_names_array = {
	...
	const std::vector<std::vector<std::string>> layers_values_array = {
	...
	const std::vector<std::vector<float>> layers_sizes_array = {
	...
	const std::vector<std::vector<ImGuiKey>> layers_keys_array = {
